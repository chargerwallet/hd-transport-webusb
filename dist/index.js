    ...
    _getDeviceList() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const chargerwalletDevices = devices.filter(dev => {
                const isChargerWallet = CHARGERWALLET_FILTER.some(desc => dev.vendorId === desc.vendorId && dev.productId === desc.productId);
    ...
    requestDevice() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.usb)
                return;
            try {
                const device = yield this.usb.requestDevice({ filters: CHARGERWALLET_FILTER });
                return device;
            }
            catch (e) {
